...
class GCN(nn.Module):
    ...
    def __init__(self, input_dim, output_dim):
        ...
        self.layers = nn.Sequential(GraphConvolution(self.input_dim, 64,
                                                     activation=F.relu,
                                                     dropout=False,
                                    ...
                                    GraphConvolution(64, self.output_dim,
...
class LSTM_GCN(nn.Module):
    ...
    def __init__(self, embedding_dim, hidden_dim, vocab_size, output_dim):
        ...
        # self.layers = nn.Sequential(GraphConvolution(self.input_dim, args.hidden, num_features_nonzero,
        self.layers = nn.Sequential(GraphConvolution(self.hidden_dim, 64,
                                                     activation=F.relu,
                                                     dropout=False,
